...
{
    static TypeId tid = TypeId("ns3::aodv_trust::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodv_trust::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodv_trust::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodv_trust::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodv_trust::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
