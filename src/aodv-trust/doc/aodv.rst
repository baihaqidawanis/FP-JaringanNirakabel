...
Class ``ns3::aodv_trust::RoutingProtocol`` implements all functionality of
...
forwarding.  The first one, ``ns3::aodv_trust::RouteOutput``, is used for
locally originated packets, and the second one, ``ns3::aodv_trust::RouteInput``,
...
this functionality are attributes of ``ns3::aodv_trust::RoutingProtocol``.
